...
public class SingleChoiceQuestionInputActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Layoutauswahl
		setContentView(R.layout.activity_question_input_single);
		...
		Button addQuestion = (Button) findViewById(R.id.saveQuestionTypeSingle);
		addQuestion.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				EditText editQuestionTypeSingleTheme = (EditText) findViewById(R.id.editQuestionTypeSingleTheme);
				// Eingabe in einen String umwandeln
				questionTheme = editQuestionTypeSingleTheme.getText().toString();
				if(TextUtils.isEmpty(questionTheme)) {
					editQuestionTypeSingleTheme.setError(getString(R.string.editText_errorMessage));
				    return;
				}
				
				// Auslesen Textfeld Frage
				EditText editQuestionTypeSingleQuestion = (EditText) findViewById(R.id.editQuestionTypeSingleQuestion);
				// Eingabe in einen String umwandeln
				questionText = editQuestionTypeSingleQuestion.getText().toString();
				// Prüfen, ob Feld leer ist
				if(TextUtils.isEmpty(questionText)) {
					editQuestionTypeSingleQuestion.setError(getString(R.string.editText_errorMessage));
				    return;
				}
				...
				editQuestionTypeSingleTheme.setText("");
				editQuestionTypeSingleQuestion.setText("");
		        ...
		        Toast.makeText(SingleChoiceQuestionInputActivity.this, "Frage gespeichert.", Toast.LENGTH_LONG).show();
		...
		@Override
		public void onClick(View v) {
			Intent intentreturnmenu = new Intent(SingleChoiceQuestionInputActivity.this, LandingActivity.class);
			SingleChoiceQuestionInputActivity.this.startActivity(intentreturnmenu);
		}
		});
