...
public class MultipleQuestionInputActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Layoutauswahl
		setContentView(R.layout.activity_question_input_multiple);
		...
		Button addQuestion = (Button) findViewById(R.id.saveQuestionTypeMultiple);
		addQuestion.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				EditText editQuestionTypeMultipleTheme = (EditText) findViewById(R.id.editQuestionTypeMultipleTheme);
				// Eingabe in einen String umwandeln
				questionTheme = editQuestionTypeMultipleTheme.getText().toString();
				if(TextUtils.isEmpty(questionTheme)) {
					editQuestionTypeMultipleTheme.setError(getString(R.string.editText_errorMessage));
				    return;
				}
				
				// Auslesen Textfeld Frage
				EditText editQuestionTypeMultipleQuestion = (EditText) findViewById(R.id.editQuestionTypeMultipleQuestion);
				// Eingabe in einen String umwandeln
				questionText = editQuestionTypeMultipleQuestion.getText().toString();
				// Prüfen, ob Feld leer ist
				if(TextUtils.isEmpty(questionText)) {
					editQuestionTypeMultipleQuestion.setError(getString(R.string.editText_errorMessage));
				    return;
				}
				...
				editQuestionTypeMultipleTheme.setText("");
				editQuestionTypeMultipleQuestion.setText("");
		        ...
		        Toast.makeText(MultipleQuestionInputActivity.this, "Frage gespeichert.", Toast.LENGTH_LONG).show();
		...
		@Override
		public void onClick(View v) {
			Intent intentreturnmenu = new Intent(MultipleQuestionInputActivity.this, LandingActivity.class);
			MultipleQuestionInputActivity.this.startActivity(intentreturnmenu);
		}
		});
